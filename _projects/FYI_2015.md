...
The main challenges of LIVAS can be concluded into three points:
...
**Light:** Aircraft engineers fight for every gram to make the aircraft lighter to make more profite, if LIVAS is expected to be mounted on the airplane, it should be as light as possible.
